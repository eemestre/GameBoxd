...
public class ListaFrame extends javax.swing.JFrame {
     ...
     */
    public ListaFrame(Lista lista, User u) {
        this.lista = lista;
        this.usuario = u;
    ...
    private void refresh() {
        ...
        view.revalidate();
        view.repaint();
        jogos = c.getJogosDaLista(lista);
        for(Jogo j : jogos) {
            view.add(new ListaJogoPanel(j, usuario, lista.getId()));
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText(this.lista.getNome());
